...
# 実行方法
1. 以下のURLからダウンロードするか、alarmerフォルダーを実行するディレクトリへ置いてください。
...
CSV_FILE_NAME='ここにファイル名を入れる'

2. アラーム音を変更したい場合は、実行するディレクトリにsettings.pyを作成し、以下をコピー&ペーストしてください。

MUSIC_FILE_NAME='ここにファイル名を入れる'

※再生可能な音声ファイルは、OGGファイルや非圧縮形式のWAVファイル、mp3ファイル等です。